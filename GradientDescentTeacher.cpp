...
*
* \brief A teacher which uses gradient descent to train a model
*
* \author $Author: dh$
*
* \version $Version: 1.0$
...
#include <vector>
#include "GradientDescentTeacher.h"

#include <iostream>

using namespace std;

GradientDescentTeacher::GradientDescentTeacher(FeedForwardNeuralNetwork* model, vector<SupervisedData*> dataset)
{
...
GradientDescentTeacher::~GradientDescentTeacher()
{

}


void GradientDescentTeacher::train()
{
  double cost = 0.0;
  double learningRate = 0.25;
  int numIterations = 0;

  cout << "Is the Stopping criteria here?" << endl;
...
void GradientDescentTeacher::setStoppingCriteria(StoppingCriteria* criteria)
{
